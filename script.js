...
Trendsongs.forEach((song, index) => {
    ...
    <div style="width:100%;height:70%;position:relative;">
      <img style="width:99%;height:99%;max-height:250px" src="${song.image}">
...
function setVolume(percent) {
    ...
    const musicWidth = music.offsetWidth;

    const rightOffset = musicWidth * 0.04;
    const rightPx = (1- percent) * barWidth;

    volumeFill.style.width = percent * barWidth + "px";
    volumeFill.style.right = rightOffset + rightPx + "px";

    volumePoint.style.right =
        rightOffset + rightPx - volumePoint.offsetWidth / 2 + "px";
}
